...
function makeTreasures (num: number) {
    for (let index = 0; index < num; index++) {
        myTreasure = sprites.create(img`
            ...
            . . . . . . . . . . . . . . . . 
            `, SpriteKind.Food)
        tiles.placeOnRandomTile(myTreasure, sprites.dungeon.floorDark0)
        nTreasures += 1
    }
}
...
function makeEnemies (num: number) {
    for (let index = 0; index < num; index++) {
        ...
        myEnemy.follow(mySprite, randint(10, 40))
    }
}
function makeLives (num: number) {
    for (let index = 0; index < num; index++) {
...
scene.onOverlapTile(SpriteKind.Player, sprites.dungeon.doorLockedSouth, function (sprite, location) {
    if (nTreasures <= 0) {
        ...
        sprites.destroyAllSpritesOfKind(SpriteKind.Lives)
